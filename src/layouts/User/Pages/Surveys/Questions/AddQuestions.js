			...
			<Formik
				...
				onSubmit={(values) => {
					Swal.fire({
						...
						if (res.isConfirmed) {
							console.log(values);
							dispatch(addQuestions({ ...values, Id: params.id, history }));
						}
					});
				}}>
																					...
																					<Row className='justify-content-center'>
																						...
																						<Col sm={4} className='mt-4'>
																							<Select
																								...
																								options={criterias.map((criteria) => {
																									return {
																										label: criteria.Name,
																										value: criteria.Id,
																									};
																								...
																								onChange={(value) => {
																									setFieldValue(`questions.${index}.Criteria1Id`, value.value);
																								}}
																							/>
																						</Col>
																						<Col sm={4} className='mt-4'>
																							<Select
																								...
																								onChange={(value) => {
																									setFieldValue(`questions.${index}.Criteria2Id`, value.value);
																								}}
																							/>
																						</Col>
																					</Row>
