...
const PollsterGroups = () => {
  ...
  const pollsterGroupsData = useSelector((state) => state.pollsterGroups.pollsterGroupsData);
          ...
          <Card className="p-3">
            <CardHeader>
              <Row className="justify-content-between align-items-center">
                ...
                <Button color="info" onClick={()=>history.push(getLayoutName(history)+"/create/pollstergroup")}>Anketör Grubu Oluştur</Button>
              </Row>
            </CardHeader>
            <CardBody className="p-0 my-5">
              ...
              <CommonTable tableData={pollsterGroupsData} actionPageNames={{edit: getLayoutName(history)+"/edit/pollstergroup/"}} columns={[{ name: "Grup İsmi" }]} deleteAction={deletePollsterGroup} />
            </CardBody>
          </Card>
        </div>
      );
