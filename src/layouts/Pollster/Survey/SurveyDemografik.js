          ...
          <Formik
            ...
            onSubmit={(values) => {
              ...
              if (
                ...
                JSON.parse(JSON.parse(survey.DemografikJson)).length
              ) {
                Swal.fire({
                  ...
                  <CardBody className="my-3">
                    <FieldArray
                      render={(arrayHelpers) => {
                        return (
                          <Row>
                            {JSON.parse(JSON.parse(survey.DemografikJson)) ? (
                              JSON.parse(JSON.parse(survey.DemografikJson)).map(
                                (item, index) => {
                                  if (item) {
                                    return (
                                      <Col sm={12} md={4}>
